...
function App() {
    ...
    useEffect(() => {
        ...
        const timer = () => {
            ...
            if (state.furry.x >= state.grid.width || state.furry.x < 0 || state.furry.y >= state.grid.height || state.furry.y < 0) {
            ...
            if (!state.isGameOver)
                interval = setInterval(timer, state.speed)
        }
        ...
        <div className="App">
            ...
            {state.isGameOver &&
                <div className="game-over">
                    <div>   GAME OVER!! </div>
                    <div className="button" onClick={handleClick}> Click here to play again</div>
                </div>
            }
